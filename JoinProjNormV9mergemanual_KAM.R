...
MYDIR <- "W:/CCSI/TECH/NYSERDA/InfrastructureVulnerability/Task8/DATA/FLOW/SS_Attributed/ZS_Corrections"
setwd(MYDIR)

normfile <- "W:/CCSI/TECH/NYSERDA/InfrastructureVulnerability/Task8/DATA/FLOW/FinalFlows/B_NormalFlows.txt"
projfile <- "B_pr45_25_49.txt"
...
filesavename <- paste0('change_',filename,'.txt')
write.table(change, filesavename, sep="\t", row.names = FALSE)
